...
def check_volcal_only():
    ...
    root.is_primary_stem_only_Demucs_var.set(False)
    root.is_secondary_stem_only_var.set(True)
    root.is_secondary_stem_only_Demucs_var.set(True)
    return 'select volcal only'

def check_instrumental_only():
    root.is_primary_stem_only_var.set(True)
    root.is_primary_stem_only_Demucs_var.set(True)
    root.is_secondary_stem_only_var.set(False)
    root.is_secondary_stem_only_Demucs_var.set(False)
    return 'select instrumental only'
