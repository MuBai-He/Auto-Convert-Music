...
class Svc(object):
    def __init__(self, net_g_path, config_path,
                 device=None,
                 cluster_model_path="sovits4.1/logs/44k/kmeans_10000.pt",
                 nsf_hifigan_enhance = False,
                 diffusion_model_path="sovits4.1/logs/44k/diffusion/model_50000.pt",
                 diffusion_config_path="sovits4.1/logs/44k/diffusion/diffusion.yaml",
